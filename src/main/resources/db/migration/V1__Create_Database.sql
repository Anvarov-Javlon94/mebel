...
create table order_details_model (
    id int8 generated by default as identity,
     order_address varchar(255),
      order_city varchar(255),
       order_date timestamp,
        order_date_of_served timestamp,
         order_id int8,
          order_name varchar(255),
           order_pay_type varchar(255),
            order_phone varchar(255),
             order_session_id varchar(255),
                 ...
                 product_name varchar(255),
                  product_photo varchar(255),
                   product_price float8,
                    product_product_character varchar(255),
                     product_product_description varchar(255),
                      product_register_date timestamp,
                      product_view_count int4, primary key (id),
                        quantity int4,
                            total_price float8);
